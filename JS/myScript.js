...
function galleryR() {
    ...
    document.getElementById("gallery1").src = "Images/pizza1.png";
    document.getElementById("gallery1").style.opacity = 1;
    document.getElementById("gallery2").src = "Images/pizza2.png";
    ...
    function timeout() {
        ...
        if (c <= k) {
            ...
            if ((!pr) && (!ne)) {
                ...
                document.getElementById("gallery1").src = "Images/pizza" + i + ".png";
                document.getElementById("gallery1").style.opacity = 1;
                if (i < 9) {
                    document.getElementById("gallery2").src = "Images/pizza" + (i + 1) + ".png";
                    document.getElementById("gallery2").style.opacity = 0;
                } else {
                    document.getElementById("gallery2").src = "Images/pizza1.png";
                    document.getElementById("gallery2").style.opacity = 0;
                }
            }
            if (pr) {
